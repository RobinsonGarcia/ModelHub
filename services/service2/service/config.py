...
service_cfg = CONFIG["SERVICE_CONFIG"].get("service2", {})
SERVICE_NAME = service_cfg.get("name", "service2")
PORT = service_cfg.get("port", 5003)  # default fallback if not set in .env
